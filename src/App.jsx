...
function setupSEO() {
  ...
  ld.textContent = JSON.stringify({
    ...
    "sameAs": [
      ...
      "https://www.youtube.com/@sunpowerua"
    ]
  });
}
  ...
  return (
    <>
      ...
      <footer style={{ background:"#2A2A2A",padding:"clamp(40px,6vw,70px) 0 0" }}>
        <div className="container">
          {/* Центральна частина — лого + соцмережі + навігація */}
          <div style={{ textAlign:"center",paddingBottom:40,borderBottom:"1px solid rgba(255,255,255,.08)" }}>
            {/* Лого */}
            <div style={{ display:"flex",justifyContent:"center",marginBottom:20 }}>
              <img src={REAL_LOGO} alt="Sun.Power.Ua" style={{ height:64, width:64, objectFit:"contain" }}/>
            </div>
