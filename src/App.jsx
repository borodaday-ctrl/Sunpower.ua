...
function setupSEO() {
  ...
  ld.textContent = JSON.stringify({
    ...
    "sameAs": [
      ...
      "https://www.facebook.com/Sunpowerua",
...
const SEED_PRODUCTS = [
  ...
  { id:19, cat:"Self-Made", name:"Self-Made 8 кВт +АКБ", price:239000, oldPrice:null, mountUAH:0, img:null, imgSrc:KIT_IMG, badge:null, rating:4.85, reviews:31, power:"8 кВт", warranty:"10 років (обладн.)", brand:"Sun Power UA", desc:"14×LONGi 615M + Deye SUN-8K гібрид + Deye SE-F16-С 16кВт·год. Курс $1=44.5₴, ціна орієнтовна.", panelName:"14×LONGi 615M", invName:"Deye SUN-8K гібрид", akbName:"Deye SE-F16-С 16кВт·год", specs:{"panel": [["Потужність", "615 Вт"], ["ККД", "22.5%"], ["Тип елементів", "HPBC Mono (Hi-MO 6)"], ["К-сть елементів", "132"], ["Напруга Vmp", "43.8 В"], ["Гарантія", "15/30 років"], ["Розміри", "2278×1134×30 мм"]], "inverter": [["Потужність", "8 кВт"], ["Фаза", "1"], ["Напруга", "48В (LV)"], ["MPPT", "2"], ["ККД", "97.6%"], ["Тип", "Гібридний"]], "akb": [["Ємність", "16 кВт·год"], ["Хімія", "LiFePO4"], ["Напруга", "51.2В / 314Ah"], ["Циклів заряду", "6000+"], ["Гарантія", "10 років"]]} },
  { id:20, cat:"Self-Made", name:"Self-Made 10 кВт +АКБ", price:291900, oldPrice:null, mountUAH:0, img:null, imgSrc:KIT_IMG, badge:null, rating:4.7, reviews:38, power:"10 кВт", warranty:"10 років (обладн.)", brand:"Sun Power UA", desc:"18×LONGi 615M + Deye SUN-10K гібрид + Deye SE-F16-С 16кВт·год. Курс $1=44.5₴, ціна орієнтовна.", panelName:"18×LONGi 615M", invName:"Deye SUN-10K гібрид", akbName:"Deye SE-F16-С 16кВт·год", specs:{"panel": [["Потужність", "615 Вт"], ["ККД", "22.5%"], ["Тип елементів", "HPBC Mono (Hi-MO 6)"], ["К-сть елементів", "132"], ["Напруга Vmp", "43.8 В"], ["Гарантія", "15/30 років"], ["Розміри", "2278×1134×30 мм"]], "inverter": [["Потужність", "10 кВт"], ["Фаза", "1"], ["Напруга", "48В (LV)"], ["MPPT", "2"], ["ККД", "97.6%"], ["Тип", "Гібридний"]], "akb": [["Ємність", "16 кВт·год"], ["Хімія", "LiFePO4"], ["Напруга", "51.2В / 314Ah"], ["Циклів заряду", "6000+"], ["Гарантія", "10 років"]]} },
  { id:21, cat:"Self-Made", name:"Self-Made 15 кВт +АКБ", price:339100, oldPrice:null, mountUAH:0, img:null, imgSrc:KIT_IMG, badge:null, rating:4.75, reviews:45, power:"15 кВт", warranty:"10 років (обладн.)", brand:"Sun Power UA", desc:"24×LONGi 645M + Deye SUN-15K гібрид + Deye SE-F16-С 16кВт·год. Курс $1=44.5₴, ціна орієнтовна.", panelName:"24×LONGi 645M", invName:"Deye SUN-15K гібрид", akbName:"Deye SE-F16-С 16кВт·год", specs:{"panel": [["Потужність", "645 Вт"], ["ККД", "22.8%"], ["Тип елементів", "Bifacial TOPCon (Hi-MO 7)"], ["К-сть елементів", "144"], ["Напруга Vmp", "44.9 В"], ["Гарантія", "15/30 років"], ["Розміри", "2384×1303×35 мм"]], "inverter": [["Потужність", "15 кВт"], ["Фаза", "3"], ["Напруга", "48В (LV)"], ["MPPT", "2"], ["ККД", "97.6%"], ["Тип", "Гібридний"]], "akb": [["Ємність", "16 кВт·год"], ["Хімія", "LiFePO4"], ["Напруга", "51.2В / 314Ah"], ["Циклів заряду", "6000+"], ["Гарантія", "10 років"]]} },
...
function SunPowerUASite() {
  ...
  return (
    <>
      ...
      {/* ══ CALCULATOR ══ */}
      <section id="calculator" style={{ background:"#0A0A08", padding:"clamp(28px,5vw,72px) 0", position:"relative", overflow:"hidden" }}>
                  ...
                  <thead>
                    <tr>
                      {["Критерій","☀️ СЕС+АКБ","⚡ Генератор","🔌 Мережа"].map((h,i)=>(
                        <th key={h} style={{ padding:"14px 18px",textAlign:i===0?"left":"center",fontSize:13,fontWeight:700,color:i===1?"#fff":"#333",background:i===1?"#22C55E":"#f7f7f7",fontFamily:"Syne,sans-serif",letterSpacing:".02em" }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={cr} style={{ background:ri%2===0?"#fff":"#fafafa" }}>
                        <td style={{ padding:"12px 18px",fontSize:13,color:"#333",fontWeight:600,borderBottom:ri<arr.length-1?"1px solid #f0f0f0":"none" }}>{cr}</td>
                        {vals.map((v,vi)=>(
                          <td key={vi} style={{ padding:"12px 18px",fontSize:13,textAlign:"center",color:vi===0?"#16A34A":v.startsWith("❌")?"#EF4444":"#555",fontWeight:vi===0?700:400,background:vi===0?"rgba(34,197,94,.05)":"transparent",borderBottom:ri<arr.length-1?"1px solid #f0f0f0":"none" }}>{v}</td>
                        ))}
                      </tr>
                    ))}
                  </tbody>
